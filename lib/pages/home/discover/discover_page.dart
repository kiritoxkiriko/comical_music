...
import 'package:comical_music/widgets/widget_song.dart';
...
import 'package:comical_music/model/banner.dart' as prefix0;
...
import 'package:comical_music/widgets/widget_banner.dart';
import 'package:comical_music/widgets/widget_future_builder.dart';
import 'package:comical_music/widgets/widget_play_list.dart';
...
//  }
  /// 构建推荐歌曲
  Widget _buildRecommendSong() {
    return CustomFutureBuilder<List<Song>>(
      futureFunc: NetUtils1.getRecommendSong,
      builder: (context, data) {
        return Container(
            height: ScreenUtil().setWidth(300),
            child: ListView.separated(
