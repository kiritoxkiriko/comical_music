...
final smallOrangeTextStyle = TextStyle(fontSize: 12, color: Colors.orange[700]);
...
final bold16OrangeTextStyle = TextStyle(fontSize: 16, color: Colors.orange[700], fontWeight: FontWeight.bold);
final bold18OrangeTextStyle = TextStyle(fontSize: 18, color: Colors.orange[700], fontWeight: FontWeight.bold);
...
final common10OrangeTextStyle = TextStyle(fontSize: 10, color: Colors.orange[700]);
